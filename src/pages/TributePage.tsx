...
function TributePage() {
  ...
  return (
    <>
      {/* TOP HEADER */}
      <Box className="bg-red-500">fasdfa</Box>
      <div className="h-16  flex items-center justify-between px-6 bg-white border-b border-neutral-200">
        <div className="text-red-800 text-xl font-medium">TRIBUTE</div>
<Box  className="text-red-800 text-xl font-medium">fasdf</Box>
        <div className="flex space-x-6 text-neutral-600 text-sm">
      ...
      <div className="sticky top-0 z-20 bg-white border-b border-neutral-200">
        <div className="max-w-5xl mx-auto px-6">
          <div className="flex justify-center space-x-10 text-sm text-neutral-600">
        ...
        {activeTab === "ABOUT" && (
          <div className="flex flex-col md:flex-row gap-10">
            ...
            <div className="w-full md:w-2/3">
              ...
              {/* BIO */}
              <p className="mt-8 text-neutral-700 text-sm leading-relaxed">
              ...
              <div className="mt-14">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button className="text-sm px-3 py-1 border border-neutral-300 rounded-md hover:bg-neutral-100">
                    Leave a Tribute
                  </button>
                </div>
                ...
                <div className="space-y-6">
                  <div className="bg-neutral-50 border border-neutral-200 rounded-md p-4">
                    <div className="text-sm font-medium text-neutralral-800">
        ...
        {activeTab === "LIFE" && (
          <div className="flex flex-col md:flex-row gap-10">
            ...
            <div className="w-full md:w-2/3 space-y-6">
              {/* LIFE CARD 1 */}
              <div className="bg-neutralral-50 border border-neutral-200 rounded-md p-6">
                <h2 className="text-lg font-semibold text-neutral-800">
                  Early Life and Education
                </h2>

                <p className="mt-2 italic text-sm text-neutral-600">
              ...
              <div className="bg-neutral-50 border border-neutral-200 rounded-md p-6">
                <h2 className="text-lg font-semibold text-neutralral-800">
          ...
          <div className="flex flex-col md:flex-row gap-10">
            ...
            <div className="w-full md:w-2/3">
              ...
              <div className="bg-neutral-50 border border-neutral-200 rounded-md p-4 mb-6">
                <div className="flex space-x-8 text-sm text-neutral-600 border-b border-neutral-200 pb-3 mb-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  {Array.from({ length: 12 }).map((_, index) => (
                    <div
                      key={index}
                      className="aspect-square bg-neutral-200 rounded-md overflow-hidden"
                    >
                      <img
                        src="/images/test.png"
                        alt="Gallery"
